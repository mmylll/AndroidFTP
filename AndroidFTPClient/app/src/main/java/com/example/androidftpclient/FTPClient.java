...
public class FTPClient {
    ...
    public void start() throws IOException {
        ...
        addrCheck(scanner);
        ctrlSocket = new Socket(this.host, this.port);
        pw = new PrintWriter(new OutputStreamWriter(ctrlSocket.getOutputStream()));
        br = new BufferedReader(new InputStreamReader(ctrlSocket.getInputStream()));
        isrunning = userLogin(scanner, pw, br);
    ...
    public void connftp() throws IOException {
        ctrlSocket = new Socket(this.host, this.port);
    ...
    private void portRequest(PrintWriter pw, BufferedReader br){
        String cmd = "PORT ";
...
// 利用控制用的流传送PORT命令
            ...
            pw.flush();
// 接受与服务器的连接
            data_socket = serverDataSocket.accept();
